  ...
  return (
    ...
    >
      ...
      >
        ...
        <p>
          <strong>🌍 Country:</strong> {issPosition.country}
        </p>
        <p>
          <strong>📍 State:</strong> {issPosition.state || "N/A"}
        </p>
        <p>
        ...
        <p>
          <strong>🚀 Velocity:</strong> {issPosition.velocity.toFixed(2)} km/h
        </p>
        <p>
          <strong>🛰️ Altitude:</strong> {issPosition.altitude.toFixed(2)} km
        </p>
      </div>
